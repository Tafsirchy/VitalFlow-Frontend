            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  ...
                  Manage all donation requests - Total {totalRequest} requests
                </p>
              </div>
            </div>
              ...
              <table className="table w-full">
                <thead className="bg-gray-50">
                  <tr className="border-b border-gray-200">
                    ...
                    <th className="text-gray-700 font-semibold">Requester</th>
                          ...
                          <AnimatePresence>
                            {activeDropdown === request._id && (
                              <>
                                ...
                                >
                                  {/* Status update buttons - Available for both Admin and Volunteer */}
                                  {request.donation_status === "inprogress" && (
                                    <>
                                      <button
                                        onClick={() =>
